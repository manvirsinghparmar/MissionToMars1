...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Simulation simulation= new Simulation();
            ...
            phase1Item = simulation.loadItems("phase-2.txt");
        ...
        phase1Rockets = U1.getRocketcounterU1();
        ...
        phase2Rockets = U1.getRocketcounterU1() - phase1Rockets;
        System.out.println("Rockets used for phase 2: " + phase2Rockets + "\n");

        System.out.println("A total of " + U1.getRocketcounterU1() + " rockets was used.");
        u1Cost = totalCost(1);
